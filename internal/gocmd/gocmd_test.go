...
func TestListModule(t *testing.T) {
	...
	require.Equal(t, "github.com/affinda/cyclonedx-gomod", mod["Path"])
...
func TestListModules(t *testing.T) {
	...
	assert.Equal(t, "github.com/affinda/cyclonedx-gomod", mod["Path"])
	assert.Equal(t, true, mod["Main"])
}
...
func TestGetModuleGraph(t *testing.T) {
	...
	assert.Equal(t, 0, strings.Index(buf.String(), "github.com/affinda/cyclonedx-gomod"))
}
...
github.com/affinda/cyclonedx-gomod/internal/cli/cmd/mod
